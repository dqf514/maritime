...
ADDON_CATALOG = [
    ...
    {
        "id": "teams",
        "name": "VoyageOS for Teams",
        "description": "Adaptive cards for approvals, voyage alerts, and OmniSearch-style deep links into VoyageOS.",
        "manifest": "/office/teams/manifest.json",
        "host": "Teams",
    },
    {
        "id": "excel",
        "name": "VoyageOS for Excel",
        "description": "Pull TCE / P&L / aging into workbooks; push estimate scenarios back to VoyageOS.",
        "manifest": "/office/excel/manifest.xml",
        "host": "Excel",
    },
    {
        "id": "sharepoint",
        "name": "VoyageOS SharePoint library sync",
        "description": "Map charter / voyage document libraries; keep SSOT links in VoyageOS.",
        "manifest": None,
        "host": "SharePoint",
    },
]
